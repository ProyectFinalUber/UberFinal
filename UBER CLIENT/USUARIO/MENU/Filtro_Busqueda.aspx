<%@ Page Title="" Language="C#" MasterPageFile="~/Paginas_Maestras/Menu.master" AutoEventWireup="true" CodeFile="Filtro_Busqueda.aspx.cs" Inherits="USUARIO_MENU_Filtro_Busqueda" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</CENTER><br /><span id="menu">COMIDA</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </asp:LinkButton>
  ...
  <path fill-rule="evenodd" d="M2 15v-1c0-1 1-4 6-4s6 3 6 4v1H2zm6-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>
        ...
        <div id="Busqueda">
            <center>
                <asp:TextBox ID="TextBox1" runat="server" Width="70%" Height="7%" class="form-control" CssClass="auto-style4" PlaceHolder="Pizza Con piña"></asp:TextBox> <br /><br /> 
                    <asp:LinkButton ID="LinkButton6" runat="server" class="btn btn-outline-primary" OnClick="LinkButton6_Click" >Hacer Una Busqueda</asp:LinkButton><br /><br />
    ...
    <section id="Desarrollo" class="auto-style2">
        <br /><br />
        <center><h1>RESULTADO DE LA BUSQUEDA</h1></center> <br /><br />
        <asp:DataList ID="DataList1" runat="server" DataSourceID="SqlDataSource1" HorizontalAlign="Center" RepeatColumns="4" CssClass="auto-style1" OnItemCommand="DataList1_ItemCommand">
            <ItemTemplate>
...
<br />
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:UBER_EATSConnectionString %>" SelectCommand="SELECT NOMBRE, PRECIO, IMAGEN_PRESENTACION, DESCRIPCION,RESTAURANTE,PRECIO,CATEGORIA_PRODUCTO FROM PRODUCTO WHERE (NOMBRE LIKE '%'+@NOMBRE+'%')">

            <SelectParameters>
                <asp:ControlParameter ControlID="GUARDO_FILTRO" Name="NOMBRE" PropertyName="Text" />
            </SelectParameters>
        </asp:SqlDataSource>
    </section>
</asp:Content>
