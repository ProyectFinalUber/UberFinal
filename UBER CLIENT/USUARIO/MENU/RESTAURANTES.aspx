<%@ Page Title="" Language="C#" MasterPageFile="~/Paginas_Maestras/Menu.master" AutoEventWireup="true" CodeFile="RESTAURANTES.aspx.cs" Inherits="USUARIO_MENU_RESTAURANTES" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</CENTER><br /><span id="menu">COMIDA</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </asp:LinkButton>
        ...
        <li class="nav-item">
               <asp:LinkButton ID="LinkButton3" runat="server"  class="nav-link disabled" Enabled="false" > <CENTER><svg width="4em" height="4em" viewBox="0 0 16 16" class="bi bi-shop" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  ...
  <path fill-rule="evenodd" d="M2 15v-1c0-1 1-4 6-4s6 3 6 4v1H2zm6-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>
    ...
    <section id="portada" class="auto-style1">
        ...
        <div id="Busqueda">
            <center>
                <asp:TextBox ID="TextBox1" runat="server" Width="70%" Height="7%" class="form-control" CssClass="auto-style4" PlaceHolder="Pizza Con piña"></asp:TextBox> <br />
                <br />
                <br />
    ...
    <section id="Desarrollo">
        ...
        <asp:DataList ID="DataList1" runat="server" DataSourceID="SqlDataSource1" HorizontalAlign="Center" RepeatColumns="4" OnItemCommand="DataList1_ItemCommand">
            <ItemTemplate>
                ...
                <center><asp:image ID="IMAGEN_PRESENTACIONLabel" runat="server" ImageUrl='<%# Eval("IMAGEN") %>' /></center>
                <div class="card-body">
                    <asp:Label ID="Label2" runat="server" Text="Nombre"></asp:Label> <br />
            <h5 class="card-title"><asp:Label ID="Label1" runat="server" Text='<%# Eval("NOMBRE") %>' /></h5>
             
                    <asp:Label ID="Label3" runat="server" Text="Direccion"></asp:Label><br />
            <p class="card-text"><asp:Label ID="DESCRIPCIONLabel" runat="server" Text='<%# Eval("DIRECCION") %>' /></p>
            
         </div>
             <ul class="list-group list-group-flush" style="background-color:rgb(52, 58, 64);">
             <li class="list-group-item" style="background-color:rgb(52, 58, 64);"><asp:Label ID="Label10" runat="server" Text="Numero de Telefono:"></asp:Label></li> <br />
             <li class="list-group-item" style="background-color:rgb(52, 58, 64);"> 
                 <asp:Label ID="Label4" runat="server" Text='<%# Eval("TELEFONO") %>' />
             </li>
           ...
           <asp:LinkButton ID="Insertar" runat="server" class="btn btn-outline-primary" CommandName="Selecciono">Ver los productos relacionados</asp:LinkButton>
        </div>
        </div>
...
<br />
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:UBER_EATSConnectionString %>" SelectCommand="SELECT [NOMBRE], [IMAGEN],[DIRECCION],[TELEFONO] FROM [RESTAURANTE]"></asp:SqlDataSource>
    </section>
</asp:Content>
